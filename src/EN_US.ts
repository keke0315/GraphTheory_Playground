export default {
    ...
    SevenBridgesInfoBody: "<p>The Seven Bridges of K\u00f6nigsberg is a classic problem that led to the foundations of graph theory, studied by Euler in the 18th century. It asks whether one can walk through the city and cross each bridge exactly once.</p><p>In this mode, you can color edges to mark a traversal. Each edge can be colored once to indicate it has been used, and used edges should not be repeated.</p>",
    ThisTask: "This task",
