export default {
    ...
    RamseyNumberInfoBody: "<p>The Ramsey number $R(s, t)$ is the smallest $n$ such that any graph on $n$ vertices contains a clique of size $s$ or an independent set of size $t$. It formalizes the idea that complete disorder is impossible in large enough graphs.</p><p>In this mode, you can explore graphs and think about guaranteed cliques or independent sets as the number of vertices grows.</p>",
